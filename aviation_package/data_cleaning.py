...
def insert_cleaned_aviation_data():
    ...
    try:
        ...
        df['departure_scheduled'] = pd.to_datetime(df['departure_scheduled'], errors='coerce').dt.strftime('%Y-%m-%d %H:%M:%S')
        df['departure_estimated'] = pd.to_datetime(df['departure_estimated'], errors='coerce').dt.strftime('%Y-%m-%d %H:%M:%S')
        df['arrival_scheduled'] = pd.to_datetime(df['arrival_scheduled'], errors='coerce').dt.strftime('%Y-%m-%d %H:%M:%S')
        df['arrival_estimated'] = pd.to_datetime(df['arrival_estimated'], errors='coerce').dt.strftime('%Y-%m-%d %H:%M:%S')
